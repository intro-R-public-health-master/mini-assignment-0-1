...
---
**Due Saturday, September 7 @ 11:59pm through Github**
...
* **Pronouns (if you want to share, otherwise just leave blank):** she/her
* **Do you have any previous programming experience?**  I once took a course in `C++` when I was in college.  I have been programming in `R` for almost 20 years (yikes!), but I still learn how to do new things with it every day.
* **Why are you taking this course?** Because everytime I teach this course I learn something new about `R`.  Also, it's my job.
* **Anything else you would like me to know?** I'm looking forward to a great semester!
...
7. Another nice think about `.Rmd` files is that it makes it easy to include graphics in your reports without having to copy and paste.  Run the code chunk below and look at the graph that is produced in the `Plots` tab in the bottom right corner of RStudio:
...
9. If your document successfully knit without error, you are ready to submit your assignment through Github.  To do so, follow the steps below.  (If your document didn't successfully knit, please reach out to me over email at `phbiostats@jhu.edu` so I can help you trouble-shoot the issue.)
