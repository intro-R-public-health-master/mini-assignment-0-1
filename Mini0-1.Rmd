...
---
**Due Thursday Sept 4 through Github**
...
* **Do you have any previous programming experience?**  I took C and C++ in college, then learned APL (stands for "a programming language"), Delphi and Visual Basic when I worked as a consultant between undergrad and grad school.  I have been programming in `R` for over 20 years (yikes!), but I still learn how to do new things with it every day. Often I learn something new while teaching the course because one of you figures out something cool.
