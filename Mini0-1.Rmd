...
---
**Due Thursday Sept 10 through Github**
...
* **Do you have any previous programming experience?**  I took C and C++ in college, then learned APL (stands for "a programming language", gotta love that programmer humor), Delphi and Visual Basic when I worked as a consultant between undergrad and grad school.  I have been programming in `R` for over 20 years (yikes!), but I still learn how to do new things with it all the time. Often I learn something new while teaching the course because one of you figures out something cool.
...
4. One way you can interact with an `.Rmd` file is by running code "chunks" by clicking the green forward-facing triangle at the top of the chunk.  Run the code chunk below:
